...
if __name__ == '__main__':
    ...
    for n in range(10):
        print("epoch: ", n)
        features, adj, label_true_te, data = GCN_data_loader.load_fast(DATASET)
        [_, cluster_number] = label_true_te.shape
        label_temp, loss_list = GCN_REGC_model.use_REGC(data, features, adj, cluster_number)
