...
class REGC(nn.Module):
    ...
    def __init__(self, input_dim, out_put_dim):
        ...
        self.fc2 = nn.Linear(256, out_put_dim, bias=False)

    def forward(self, adjacency, feature):
        feature = self.norm1(feature)
        h1 = F.leaky_relu(self.fc1(adjacency.mm(feature)))  # leaky_relu F.leaky_relu
        h1 = self.norm2(h1)
        h2 = F.leaky_relu(self.fc2(adjacency.mm(h1)))  # leaky_relu F.leaky_relu
...
def use_REGC(features_in, adj_in, c_num, feat_map='union', neigh=25):
    '''
