import numpy as np
import SAGE_REGC_model
import SAGE_data_loader
import scores
...
if __name__ == '__main__':
    ...
    for n in range(20):
        print("epoch: ", n)
        features, adj, label_true_te, data = SAGE_data_loader.load_fast(DATASET)
        [_, cluster_number] = label_true_te.shape
        label_temp, loss_list = SAGE_REGC_model.use_REGC(data, features, adj, cluster_number)
